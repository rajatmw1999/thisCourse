    ...
    return (
      <div className="CourseDetail">
        <div class="container">
          ...
          <h2 id="coursename" class="h1class new" >{this.props.data.coursename}</h2>
          </div>
          <div class="col-3">
            <h2 class="h2bold">₹&nbsp;{this.props.data.price}</h2>
          ...
          <div class="details jumbotron">
            <div class="row">
            <div class="coursedestag col-9">
            <h3 class="h1coursedesc">Course Description</h3>
            <br></br>
            <div>{this.props.data.courseDesc}</div>
            <br></br>
