...
//}
				const skill = new Skill({
						...
						platform:'coursera',
						nameSkill: data1,
						Courses: [ {NameofCourse: data.courseName[0], Price: data.price[0],LinkToCourse: data.link[0],Instructor:data.instructorName[0],NumberofHours:data.NumberofHours[0],CourseDescription: data.courseDescription[0],UrlOfImageThumbnail:data.UrlOfImageThumbnail[0],StudentsEnrolled:data.StudentsEnrolled[0],Rating:data.Rating[0]},
						...
						// Courses: [ 	{NameofCourse: data.courseName[0].replace(/['"]+/g, '').replace(/\//g, ""),UrlOfImageThumbnail:data.UrlOfImageThumbnail[0], Rating:data.rating[0],Instructor:data.instructorName[0],LinkToCourse: data.link[0].replace(/^\/|\/$/g, '')},
									// {NameofCourse: data.courseName[1].replace(/"/g, "").replace(/\//g, ""),UrlOfImageThumbnail:data.UrlOfImageThumbnail[1], Rating:data.rating[1],Instructor:data.instructorName[1],LinkToCourse: data.link[1]},
									// {NameofCourse: data.courseName[2].replace(/"/g, "").replace(/\//g, ""),UrlOfImageThumbnail:data.UrlOfImageThumbnail[2], Rating:data.rating[2],Instructor:data.instructorName[2],LinkToCourse: data.link[2]},
									// {NameofCourse: data.courseName[3].replace(/"/g, "").replace(/\//g, ""),UrlOfImageThumbnail:data.UrlOfImageThumbnail[3], Rating:data.rating[3],Instructor:data.instructorName[3],LinkToCourse: data.link[3]},
									// {NameofCourse: data.courseName[4].replace(/"/g, "").replace(/\//g, ""),UrlOfImageThumbnail:data.UrlOfImageThumbnail[4], Rating:data.rating[4],Instructor:data.instructorName[4],LinkToCourse: data.link[4]}]
